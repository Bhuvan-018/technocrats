...
import InputSection from '../predictor/components/InputSection';
import ForecastCard from '../predictor/components/ForecastCard';
import MarketSnapshot from '../predictor/components/MarketSnapshot';
import TrustMetrics from '../predictor/components/TrustMetrics';
import DeepDive from '../predictor/components/DeepDive';
import {
  getMarketStatus,
  getCompanies,
  getPrediction,
...
export function Predictor() {
  ...
  useEffect(() => {
    Promise.all([getMarketStatus(), getCompanies()]).then(([status, companiesList]) => {
